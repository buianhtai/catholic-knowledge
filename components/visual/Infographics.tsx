...
type StoryNode={label:string;detail?:string;group?:string};
...
export function RelationshipOrbit({center,items,centerDetail='tri thức kết nối'}:{center:string;items:OrbitItem[];centerDetail?:string}){
  ...
  return <div className={styles.orbit} aria-label={`Sơ đồ liên hệ: ${center}`}>
    ...
    <div className={styles.orbitCenter}><strong>{center}</strong><small>{centerDetail}</small></div>
