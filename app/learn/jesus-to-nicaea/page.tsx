...
const chapters = [
  {id:'chapter-1',year:'k. 30',kicker:'Khởi đầu',title:'Chúa Giêsu và các Tông đồ',body:'Từ Galilê đến Giêrusalem, lời rao giảng về Nước Thiên Chúa quy tụ một cộng đoàn môn đệ. Từ đây, Tin Mừng bắt đầu lan vượt ra ngoài biên giới của một vùng đất.',asset:'place.jerusalem-holy-sepulchre',nodes:['Galilê','Nhóm Mười Hai','Giêrusalem','Tin Mừng'],tone:196},
  {id:'chapter-2',year:'k. 30',kicker:'Lên đường',title:'Lễ Ngũ Tuần – Giáo Hội bắt đầu sứ mạng',body:'Các môn đệ bước ra khỏi căn phòng đóng kín. Việc loan báo Tin Mừng trở thành một sứ mạng công khai, và cộng đoàn Giáo Hội bắt đầu mở rộng.',asset:'person.peter',nodes:['Chúa Thánh Thần','Phêrô','Phép Rửa','Công vụ'],tone:220},
  {id:'chapter-3',year:'30–60',kicker:'Tin Mừng vượt biên giới',title:'Phêrô, Phaolô và hành trình loan báo Tin Mừng',body:'Từ Giêrusalem, Antiôkia đến Rôma, các tuyến đường quanh Địa Trung Hải trở thành mạng lưới truyền giáo. Những cộng đoàn mới cũng đặt ra những câu hỏi mới về đức tin và đời sống Kitô hữu.',asset:'person.paul',nodes:['Phêrô','Phaolô','Antiôkia','Rôma'],tone:174},
  {id:'chapter-4',year:'64–303',kicker:'Đức tin giữa thử thách',title:'Giữa bách hại, Giáo Hội vẫn lớn mạnh',body:'Đức tin không lớn lên trong an toàn. Chứng tá của các vị tử đạo, các nhà hộ giáo và các Giáo Hội địa phương góp phần làm cho căn tính Kitô giáo ngày càng rõ nét.',asset:'art.gutenberg-bible',nodes:['Các vị tử đạo','Hộ giáo','Rôma','Giáo Hội địa phương'],tone:130},
  {id:'chapter-5',year:'313',kicker:'Bước ngoặt',title:'Constantinô và bước ngoặt của Đế quốc',body:'Khi các Kitô hữu có thể công khai sống đức tin hơn, Giáo Hội bước vào một giai đoạn lịch sử mới. Những tranh luận thần học giờ đây có thể quy tụ các giám mục từ nhiều miền khác nhau.',asset:'person.constantine',nodes:['Constantinô','Milan','Giám mục','Đế quốc'],tone:164},
  {id:'chapter-6',year:'325',kicker:'Một lời tuyên xưng chung',title:'Công đồng Nixêa – một lời tuyên xưng chung',body:'Tại Nixêa, các giám mục đối diện với một câu hỏi mang tính quyết định về căn tính của Đức Kitô. Kinh Tin Kính trở thành điểm quy tụ giúp các cộng đoàn cùng tuyên xưng một đức tin.',asset:'art.nicaea-icon',nodes:['Nixêa','Ariô','Athanasiô','Kinh Tin Kính'],tone:246},
] as const;
